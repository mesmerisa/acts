 ...
 public:
  ...
  struct Config {
    ...
    std::map<std::string, PlotHelpers::Binning> varBinning = {
        ...
        {"Residual_d0", PlotHelpers::Binning("r_{d0} [mm]", 100, -0.2, 0.2)},
        {"Residual_z0", PlotHelpers::Binning("r_{z0} [mm]", 100, -0.15, 0.15)},
        {"Residual_phi",
         PlotHelpers::Binning("r_{#phi} [rad]", 100, -0.001, 0.001)},
        {"Residual_theta",
         PlotHelpers::Binning("r_{#theta} [rad]", 100, -0.0001, 0.0001)},
        {"Residual_qop",
         PlotHelpers::Binning("r_{q/p} [c/GeV]", 100, -0.001, 0.001)},
