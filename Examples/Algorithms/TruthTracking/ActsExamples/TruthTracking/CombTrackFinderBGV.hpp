...
/// the chain.
class CombTrackFinderBGV final : public BareAlgorithm {
 public:
  struct Config {
    ...
    /// The input source links.
    std::string inputSourceLinks;
    /// The output proto tracks collection.
    std::string outputProtoTracks;
  };

  CombTrackFinderBGV(const Config& cfg, Acts::Logging::Level lvl);
