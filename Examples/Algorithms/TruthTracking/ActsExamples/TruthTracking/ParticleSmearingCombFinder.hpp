...
class ParticleSmearingCombFinder final : public BareAlgorithm {
 public:
  struct Config {
    /// Input truth particles collection.
    std::string inputParticles;
    /// Input track candidates from track finding
  ...
  ParticleSmearingCombFinder(const Config& cfg, Acts::Logging::Level lvl);
