...
void Mat_map3(std::string Val = "", std::string geantino = "", std::string name = ""){
  ...
  TH2F * Val_X0 = new TH2F("Val_X0","Val_X0",160,2,4,160,-4,4);
  ...
  TH2F * geantino_X0 = new TH2F("geantino_X0","geantinol_X0",160,2,4,160,-4,4);

  TH1F * comp_X0_Eta = new TH1F("comp_X0_Eta","comp_X0_Eta",160,2,4);
  TH1F * comp_X0_Phi = new TH1F("comp_X0_Phi","comp_X0_Phi",160,-4,4);
  TH2F * comp_X0 = new TH2F("comp_X0","comp_X0",160,2,4,160,-4,4);
  ...
  if(Val != ""){
    ...
    Val_file->Draw("mat_y:mat_z","fabs(mat_x)<10");
  ...
  if(geantino != ""){
    ...
    geantino_file->Draw("mat_y:mat_z","fabs(mat_x)<10");
