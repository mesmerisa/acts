...
void Mat_map2(std::string Val = "", std::string geantino = "", std::string name = ""){
  ...
  TH2F * Val_X0_Phi_spread = new TH2F("Val_X0_Phi_spread","Val_X0_Phi_spread",160,2,4,160,-4,4);
  ...
  if(Val != ""){
    ...
    Val_file->Draw("mat_y:mat_z","fabs(mat_x)<1"); // XXX
    //Val_file->Draw("mat_y:mat_z","mat_z<700");
    eta_0->Draw("Same");
    eta_1p->Draw("Same");
    eta_1n->Draw("Same");
    eta_2p->Draw("Same");
