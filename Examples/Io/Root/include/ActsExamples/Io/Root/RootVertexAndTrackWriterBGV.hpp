...
class RootVertexAndTrackWriterBGV final
 ...
 public:
  ...
  RootVertexAndTrackWriterBGV(const Config& cfg, Acts::Logging::Level lvl);

  /// Virtual destructor
  ~RootVertexAndTrackWriterBGV() final override;
 ...
 protected:
  ...
  ProcessCode writeT(const AlgorithmContext& context,
                     ...
                     const std::vector<Acts::Vertex<Acts::BoundTrackParameters>>&
