...
ActsExamples::RootVertexAndTrackWriterBGV::RootVertexAndTrackWriterBGV(
    const ActsExamples::RootVertexAndTrackWriterBGV::Config& cfg,
    Acts::Logging::Level lvl)
    : WriterT(cfg.collection, "RootVertexAndTrackWriterBGV", lvl),
      m_cfg(cfg),
...
ActsExamples::ProcessCode ActsExamples::RootVertexAndTrackWriterBGV::endRun() {
  if (m_outputFile) {
    m_outputFile->cd();
    m_outputTree->Write();
...
void ActsExamples::RootVertexAndTrackWriterBGV::ClearAll() {
  m_vx.clear();
  m_vy.clear();
  m_vz.clear();
  m_d0.clear();
...
ActsExamples::ProcessCode ActsExamples::RootVertexAndTrackWriterBGV::writeT(
    const AlgorithmContext& context,
    //const std::vector<VertexAndTracks>& vertexAndTracksCollection) {
    const std::vector<Acts::Vertex<Acts::BoundTrackParameters>>& vertexAndTracksCollection) {
